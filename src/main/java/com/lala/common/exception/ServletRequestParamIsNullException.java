 ...
 */
public class ServletRequestParamIsNullException extends RuntimeException {
    private final String parameterName;
    private final String parameterType;

    public ServletRequestParamIsNullException(String parameterName, String parameterType) {
        super("");
