...
public class Customer extends BaseEntity{
    ...
    //账单
    @OneToMany(cascade = CascadeType.ALL, fetch = FetchType.EAGER)//不启用懒加载
    @JoinColumn(name = "u_id")
    private List<LeaseBill> billList;

    public List<LeaseBill> getBillList() {
        return billList;
    }
    public void setBillList(List<LeaseBill> billList) {
